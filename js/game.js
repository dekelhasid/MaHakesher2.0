...
async function savePlayerFromDialog(event) { event.preventDefault(); const action = event.submitter?.value; if (action === 'guest') { state.player = setPlayer({ kind: 'guest', name: '' }); renderPlayerButton(); $('#player-dialog').close(); setStatus('ממשיכים כאורח/ת.'); return; }
